  ...
  return (
    <div className="relative overflow-hidden bg-navy-900">
      ...
      <div className="relative mx-auto flex min-h-[60vh] max-w-[1280px] flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <p className="mt-5 max-w-md text-md leading-relaxed text-brand-100/70">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3">
          <Link
            href="/"
            className="group inline-flex items-center gap-2 rounded-full bg-flame-500 px-6 py-3.5 text-md font-bold text-white transition-colors hover:bg-flame-600"
          >
            홈으로 가기
          ...
          <Link
            href="/board/notice"
            className="inline-flex items-center gap-2 rounded-full bg-white/10 px-6 py-3.5 text-md font-bold text-white ring-1 ring-white/25 transition-colors hover:bg-white/20"
          >
            공지사항
          </Link>
        </div>
