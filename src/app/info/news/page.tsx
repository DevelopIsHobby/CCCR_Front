        ...
        {INDUSTRY_NEWS.map((n) => (
          <li key={n.title}>
            ...
            >
              ...
              <p className="mt-4 text-[1.1rem] font-bold leading-snug text-navy-900 transition-colors group-hover:text-brand-600">
                {n.title}
              </p>
              <p className="mt-3 flex-1 text-[0.9rem] leading-relaxed text-ink-600">{n.summary}</p>
