      ...
      <div className="mt-12 grid gap-4 lg:grid-cols-2">
        {COURSES.map((c) => (
          ...
          >
            ...
            <h3 className="mt-4 text-[1.25rem] font-bold leading-snug text-navy-900">{c.title}</h3>

            <dl className="mt-5 space-y-2 border-y border-line py-5">
              <div className="flex gap-4">
                <dt className="w-20 shrink-0 text-[0.85rem] font-bold text-navy-900">교육시간</dt>
                <dd className="text-[0.875rem] text-ink-600">{c.hours}</dd>
              </div>
              <div className="flex gap-4">
                <dt className="w-20 shrink-0 text-[0.85rem] font-bold text-navy-900">교육대상</dt>
                <dd className="text-[0.875rem] text-ink-600">{c.target}</dd>
              </div>
            </dl>
