        ...
        <table className="w-full border-collapse text-left">
          <thead>
            <tr className="border-y-2 border-navy-900 bg-surface">
              <th className="w-20 px-5 py-4 text-center text-[0.875rem] font-bold text-navy-900">
                번호
              </th>
              <th className="w-28 px-5 py-4 text-[0.875rem] font-bold text-navy-900">분류</th>
              <th className="px-5 py-4 text-[0.875rem] font-bold text-navy-900">제목</th>
              <th className="w-36 px-5 py-4 text-center text-[0.875rem] font-bold text-navy-900">
                등록일
              </th>
              <th className="w-24 px-5 py-4 text-center text-[0.875rem] font-bold text-navy-900">
                조회
              </th>
            </tr>
          </thead>
            ...
            {NOTICES.map((n) => (
              <tr key={n.no} className="group border-b border-line hover:bg-brand-50/60">
                ...
                <td className="px-5 py-4">
                  <span className="inline-flex rounded bg-brand-50 px-2.5 py-1 text-[0.7rem] font-bold text-brand-700">
                    {n.category}
                  </span>
                </td>
                <td className="px-5 py-4">
                  <Link href="#" className="flex items-center gap-2">
                    <span className="text-[0.95rem] text-ink-900 transition-colors group-hover:text-brand-600">
        ...
        {NOTICES.map((n) => (
          <li key={n.no} className="border-b border-line">
            <Link href="#" className="block py-5">
              ...
              <p className="mt-3 text-[0.95rem] font-medium leading-relaxed text-ink-900">
                <span className="text-ink-400">[{n.agency}]</span> {n.title}
              </p>
